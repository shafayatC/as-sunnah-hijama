    ...
    return (
        <>
            ...
            <div id="easySliderShs1">
                ...
                <div id="essSlide">
                    <div className={parallax ? "essParalax essSliderCls" : "essSliderCls"} id="essFirst"></div>
                    <div className={parallax ? "essParalax essSliderCls" : "essSliderCls"} id="essSecond"></div>
                </div>
